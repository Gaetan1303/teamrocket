 ...
 */
final class Version20250929130752 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE sbire ADD COLUMN is_verified BOOLEAN NOT NULL');
    }

    public function down(Schema $schema): void
    {
        // this down() migration is auto-generated, please modify it to your needs
        $this->addSql('CREATE TEMPORARY TABLE __temp__sbire AS SELECT id, team_vilain_id, email, codename, roles, password, uuid FROM sbire');
        ...
        $this->addSql('INSERT INTO sbire (id, team_vilain_id, email, codename, roles, password, uuid) SELECT id, team_vilain_id, email, codename, roles, password, uuid FROM __temp__sbire');
